...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ec.Data.Entities.Statistic", b =>
                {
                    ...
                    b.Property<decimal>("PreviousEarnings")
                        .HasColumnType("numeric");

                    b.Property<decimal>("PreviousSoldCount")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Ec.Data.Entities.StatisticHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ec.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("09a59fad-4297-4aa4-9418-62329c5d9688"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FullName = "Shermatov Asadbek",
                            IsBlocked = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEHxxDGdYk8TfOjb4ItiCAPqj0b0AnrzqZhBh7kQz1JddVrxorRgoJsRTiIPef64g6A==",
            ...
            modelBuilder.Entity("Ec.Data.Entities.StatisticHistory", b =>
                {
                    b.HasOne("Ec.Data.Entities.Statistic", "Statistic")
                        .WithMany("History")
